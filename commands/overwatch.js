...
module.exports.run = async (bot, message, args) => {
  ...
  if (body.private)
    return message.reply("Blizzard is not letting me get the player stats. Player profile needs to be public to have access to stats. You can do it by going to **Options > Social > Change profile to public** in the game client.");
