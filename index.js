...
bot.on("message", async message => {
    ...
    if(cmd == `${prefix}help`){
        let embed = new Discord.RichEmbed()
            ...
            .addField("Stats", "`!fbr <epic-username> [platform pc/xbl/psn] {mode all/season}` : Looks up stats for fortnite.\nFOR LIFETIME STATS `!fbr <epic-username> [platform pc/xbl/psn]` ")
            .addField("Misc.", "`!coinflip` : Flips a coin and replies HEADS or TAILS\n`!dog` : Random dog image or gif");
